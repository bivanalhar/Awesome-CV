...
\begin{cventries}
    ...
    {}
    {
      \begin{cvitemsForEducation}
        ...
        \item {Developing both the GUI for the Interactive Machine Learning (TkInter) and the deep learning personalization model with the help of LIME (Local Interpretable Model-Agnostic Classifier) algorithm as model explainer (Tensorflow) }
      \end{cvitemsForEducation}
    }
